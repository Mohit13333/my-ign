...
//                 data-scroll-class="is-inview"
//                 data-scroll-repeat
//                 style={{ lineHeight: "1.2", maxWidth: "600px", animationDelay: "0.2s" }}
//               >
...
//                     <Image src="/assets/medal.png" alt="Grade Support" width={isMobile ? 24 : 28} height={isMobile ? 30 : 38} className="icon-img" />
//                   </div>
...
//                 >
//                   <div className="mb-2 icon-wrap" style={{ color: "#acf2d6" }}>
//                     <Image src="/assets/Union.png" alt="Location" width={isMobile ? 24 : 28} height={isMobile ? 30 : 38} className="icon-img" />
//                   </div>
...
//           @media (max-width: 768px) {
//   .info-row {
//     -webkit-mask-image: linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0,1) 40%);
