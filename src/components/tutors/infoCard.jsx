...
//                 }}
//               >
//                 Discover excellence in English education with Dubai’s best
//                 tutors. Our experts ensure effective learning, boosting language
//                 skills for success. Join us to excel in English!
//               </p>
...
@media (max-width: 991.98px) {
  .position-relative.overflow-hidden {
    position: relative;
    background-image: url("/assets/tutors.png") !important;
    background-size: cover;
    background-position: center;
    background-repeat: no-repeat;
  }
